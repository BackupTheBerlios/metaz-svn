...
public class RecordTest extends TestCase {
                ...
                throws Exception
  {
    ...
    rec = new Record(title, secured, fileFormat, didacticalFunction, productType, uri);
  ...
  public void testMandatoryStuff() {
    ...
    assertNotNull("Expected didacticalFunction metadata", rec.getDidacticFunction());
  ...
  public void testAddingOptionalMetaData() {
    ...
    assertEquals("Wrong name optional metadata", MetaData.LASTCHANGEDDATE, rec.getLastChangedDate().getName());
