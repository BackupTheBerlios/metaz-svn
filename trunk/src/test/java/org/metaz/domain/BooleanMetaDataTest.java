...
/**
 * In this test class also the methods of the superclass
 *         MetaData will be tested.
 *
 * @author E.J. Spaans  
 */
public class BooleanMetaDataTest extends TestCase
{
    ...
    public void testDescriptionGetterAndSetter()
    {
        ...
        assertTrue("Expected description to be a String",
            boolMetaData.getDescription() instanceof String);
        assertEquals("Unexpected value.", "someDescription",
            boolMetaData.getDescription());
    ...
    public void testNameGetterAndSetter()
    {
        ...
        assertTrue("Expected name to be a String",
            boolMetaData.getName() instanceof String);
