          ...
          <td><br/>
            <form action="/code/css/forms/" method="post" enctype="multipart/form-data">
              ...
              <div class="required">
                ...
                <small>We will never sell or disclose your email address to anyone.  Once your account is setup, you may add additional email addresses.</small> </div>
              <div class="required">
                ...
                <small>Must match the email address you just entered above.</small> </div>
              <div class="optional">
              ...
              <div class="optional">
                <div class="subfieldset">
                  ...
                  Help, my brother/sister is driving me crazy!</label>
                  ...
                  How can I tell my father/mother, it's time for them to retire?</label>
                  ...
                  I'm exasperated with an awkward partner!</label>
                  ...
                  How do I stop my family members from interfering?</label>
                  </fieldset>
                </div>
              </div>
              <div class="required">
                ...
                <small>Must be 250 characters or less.</small> </div>
              <div class="optional">
                <label for="image">Image:</label>
                <input type="file" name="image" id="image" class="inputFile" />
                <small>Press browse to locate a file</small> </div>
              <div class="required">
                ...
                <small>Use the <kbd>CTRL</kbd> key to select more than one.</small> </div>
              <div class="required">
                <div class="subfieldset">
                  <fieldset>
                  <h3>Availability:</h3>
                  <label for="availability_checkbox_0" class="labelCheckbox">
                  <input type="checkbox" name="availability_checkbox" id="availability_checkbox_0" class="inputCheckbox" value="Part-time" />
                  Part-time</label>
                  <label for="availability_checkbox_1" class="labelCheckbox">
                  <input type="checkbox" name="availability_checkbox" id="availability_checkbox_1" class="inputCheckbox" value="Full-time (Days)" />
                  Full-time (Days)</label>
                  <label for="availability_checkbox_2" class="labelCheckbox">
                  <input type="checkbox" name="availability_checkbox" id="availability_checkbox_2" class="inputCheckbox" value="Full-time (Swing)" />
                  Full-time (Swing)</label>
                  <label for="availability_checkbox_3" class="labelCheckbox">
                  <input type="checkbox" name="availability_checkbox" id="availability_checkbox_3" class="inputCheckbox" value="Full-time (Graveyard)" />
                  Full-time (Graveyard)</label>
                  <label for="availability_checkbox_4" class="labelCheckbox">
                  <input type="checkbox" name="availability_checkbox" id="availability_checkbox_4" class="inputCheckbox" value="Weekends Only" />
                  Weekends Only</label>
                  </fieldset>
                </div>
              </div>
              ...
              <div class="required">
                ...
                <small>May only contain letters, numbers, and underscore (_) and 8-20 characters long.</small> </div>
              <div class="required">
                <label for="password">Password:</label>
                <input type="password" name="password" id="password" class="inputPassword" size="10" maxlength="25" value="" />
                <small>Must be 8-25 characters long.</small> </div>
              <div class="required">
                ...
                <small>Must match the password you entered just above.</small> </div>
              <div class="optional">
                <label for="remember" class="labelCheckbox">
                <input type="checkbox" name="remember" id="remember" class="inputCheckbox" value="1" />
                Remember Me</label>
                <small>If you don't want to bother with having to login every time you visit the site, then checking &quot;Remember Me&quot; will place a unique identifier only our site can read that we'll use to identify you and log you in automatically each time you visit.</small> </div>
              </fieldset>
              <fieldset>
              <div class="submit">
