...
/**
    ...
    public static Document toDocument(Record r) throws Exception
    {
        ...
        if(creationDate!=null){
            doc.add(Field.UnIndexed(MetaData.CREATIONDATE, (Integer.toString((int)((Date)creationDate.getValue()).getTime()))));
        }
        MetaData lastChangedDate = r.getLastChangedDate();
        if(lastChangedDate!=null){
            doc.add(Field.UnIndexed(MetaData.LASTCHANGEDDATE, (Integer.toString((int)((Date)lastChangedDate.getValue()).getTime()))));
        }
