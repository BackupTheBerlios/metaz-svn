 ...
 *    <li>org.metaz.repository.search.service.impl = org.metaz.repository.SearchServiceImpl</li>
 *    <li>org.metaz.repository.data.service.impl = org.metaz.repository.DataServiceImpl</li>
 *  </ul>
 *
 * @author J. Goelen
 */
public class FacadeFactory {
  ...
  public static Facade createFacade() {
    ...
    try {
      ...
      logger.log(Priority.ERROR, "Error instantiating a new Facade instance", e);
