...
/**
 * Nice helper class for equality testing, assists with implementing equals() functions
 * Null values are handled correctly
 * The sister class of Equals is HashCode
 * See javadoc for java.lang.Object for more information on both methods
 * 
 * Falco Paul, 6 january 2006
 *
 * Example usage:
 *
 ...
 *
 *   MyClass that = (MyClass) anotherObject;
 *   
 ...
 * }
 *
 * Note: use Array.equals() to test for array field equality
 *  
 */
...
public final class Equals {
  ...
  /**
   * This method performs some basic equality checks on two instances (of any class)
   * It does NOT perform a real equality test... just some starter tests to rule out the obvious
   * If this test passes, you can be sure that both objects are NOT null, and are of the same class
   * 
