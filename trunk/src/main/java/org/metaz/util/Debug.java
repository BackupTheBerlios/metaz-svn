...
/**
 * Simple helper methods for debugging and stack traces, etc
 * Will grow as needed...
 */
...
public class Debug extends Object {
  ...
  /**
   * Pretty prints an exception and barfs a strack trace
   * Prints everything with DEBUG level to the logger
   * @param e The exception to print nicely
   */
  ...
  /**
   * Prints all properties of an object to the logger. To print the
   * properties, it invokes those getter methods on objects that do
   * not have parameters.
   * Prints everything with DEBUG level to the logger
