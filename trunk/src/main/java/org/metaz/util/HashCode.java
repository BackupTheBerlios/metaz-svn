 ...
 *
 * Usage: int result = HashCode.SEED;
...
public final class HashCode {
  ...
  /**
   * Returns a hash code for a byte/short/int parameter, given a seed
   * Note that bytes and shorts are also handled by this method (through implicit conversion)
   * @param  seed    The seed
   * @param  value   The value
   * @return int     A hash code based on the given seed and value
   */
  ...
  /**
   * Returns a hash code for a Object parameter, given a seed
   * Object may be null. Array objects are allowed
   * If Object is an array, then each element may be a primitive or a (possibly null) object
   * @param  seed    The seed
   * @param  value   The value
   * @return int     A hash code based on the given seed and value
   */
